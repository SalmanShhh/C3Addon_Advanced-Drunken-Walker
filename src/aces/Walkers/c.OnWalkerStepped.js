export const config = {
  ...
  description:
    "Fires after each step of Step Walker only, batch runs skip it for speed. WalkerX, WalkerY, WalkerAngle and WalkerStepsLeft are valid inside. An empty filter matches all walkers.",
  params: [
    {
      id: "walkerId",
      name: "ID",
